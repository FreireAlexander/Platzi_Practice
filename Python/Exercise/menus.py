...
def main():
    ...
    options =["Attack 1","Attack 2","Menu 1", "Menu 2", "Attack 3", "Attack 4", "Menu 3", "Escape"]
    option = table_menu_3(4,2,Title,options)
    #option = table_menu_1(5,Title,options)    
    #option = table_menu_2(4,Title,options)
    #option = list_menu(Title, options)
    print(option)
